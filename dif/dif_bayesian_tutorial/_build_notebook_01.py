...
# 3. 백엔드 + import
# ============================================================
cells.append(md("""## 3. 백엔드 선택 및 모듈 import
...
# ============================================================
cells.append(md("""## 4. 빈도주의 MH 출력의 척도 — log-odds (로그-오즈) 정리
...
cells.append(md("""## 7. 결과 집계 — RMSE, bias, 표집 SD
...
cells.append(md("""## 8. 시각화 1 — RMSE 시나리오별 비교
...
cells.append(md("""## 9. 시각화 2 — 편향-분산 분해 (Bias-Variance Decomposition)
...
cells.append(md("""## 10. 신용구간 Coverage — \"명목 수준(nominal level)\"의 의미
...
cells.append(md("""## 11. 시뮬레이션 기반 Coverage 점검
